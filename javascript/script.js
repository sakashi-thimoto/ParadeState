function parade_state_script(copypaste) {
  ...
  document.getElementById(
    "dooOutput"
  ).value = `HQ COY ${day}/${month}/${year} ${time} HRS
...
function copyText() {
  // Get the text field
  var copyText = document.getElementById("dooOutput");
...
function resetForm() {
  document.getElementById("paradeStateForm").value = null;
  document.getElementById("dooOutput").value = null;
}
